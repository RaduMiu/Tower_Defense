...
public class TileManager {
	...
	public Tile GRASS, WATER, ROAD_LR, ROAD_TB, ROAD_B_TO_R, ROAD_L_TO_B, ROAD_L_TO_T, ROAD_T_TO_R, BL_WATER_CORNER, TL_WATER_CORNER,// BL = bottom left
	TR_WATER_CORNER,BR_WATER_CORNER, L_WATER, R_WATER, T_WATER, B_WATER,
	...
	private void createTiles() {
		...
		/*
		corners.add(BL_WATER_CORNER = new Tile(ImgFix.buildImg(getImgs(0,0, 5, 0)), id++, "BR_Corner"));    //inainte de animatie
	...
	public BufferedImage getSprite(int id) {
		return tiles.get(id).getSprite();       //tiles[i].getSprite()
	}
	...
	private BufferedImage[] getAniSprites(int xCord, int yCord) {    //metoda pt animarea apei
		BufferedImage[] arr = new BufferedImage[4];
		for(int i=0; i<4; i++) {  //4 tipuri de apa
