...
public class Editing extends GameScene implements SceneMethods{
	...
	private void drawSelectedTile(Graphics g) {  //metoda care face tile.ul din dreptul mouse.ului
	...
	private void changeTile(int x, int y) {
		if (selectedTile != null) {
			...
			if(selectedTile.getId() >= 0) {  //check for normal tile
			...
			else {   //check for start and end tile
	...
	public void keyPressed(KeyEvent e) {
		if(e.getKeyCode() == KeyEvent.VK_R)  //VK - virtual key
